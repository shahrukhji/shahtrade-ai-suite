...
const AutoTradePage = () => {
  ...
  const [activeTab, setActiveTab] = useState<'engine' | 'backtest'>('engine');
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex gap-1.5">
        <PillButton active={activeTab === 'engine'} onClick={() => setActiveTab('engine')}>⚙️ Engine</PillButton>
        <PillButton active={activeTab === 'backtest'} onClick={() => setActiveTab('backtest')}>🧪 Backtest</PillButton>
      </div>
